...
setup(
    ...
    description="Blog Framework",  # Optional
    ...
    # project.
    author="Brantley Harris",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="deadwisdom@gmail.com",  # Optional
    ...
    #
    packages=find_packages(exclude=["tests", "example"]),  # Required
    ...
    install_requires=[
        ...
        "pyyaml==5.4.1; python_version != '3.4'",
